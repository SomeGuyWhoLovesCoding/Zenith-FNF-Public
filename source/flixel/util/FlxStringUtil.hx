...
class FlxStringUtil
{
	 ...
	 */
	public static function formatTime(ms:Float, englishStyle:Bool, showMS:Bool):String
	{
		// Rewritten code??? Moment when I use ChatGPT:
		var milliseconds:Int = Std.int(ms / 10) % 100;
		var seconds:Int = Std.int(ms / 1000) /* % 3600 */;
